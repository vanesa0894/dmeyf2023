...
PARAM$finalmodel$optim$num_iterations <- 804
PARAM$finalmodel$optim$learning_rate <- 0.0332684531780975
PARAM$finalmodel$optim$feature_fraction <- 0.351005240398083
PARAM$finalmodel$optim$min_data_in_leaf <- 16245
