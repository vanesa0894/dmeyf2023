...
PARAM$finalmodel$optim$learning_rate <- 0.0417249929366275
PARAM$finalmodel$optim$feature_fraction <- 0.592519971964672
PARAM$finalmodel$optim$min_data_in_leaf <- 8015
PARAM$finalmodel$optim$num_leaves <- 758
