...
PARAM$finalmodel$optim$num_iterations <- 621
PARAM$finalmodel$optim$learning_rate <- 0.0375441947507291
PARAM$finalmodel$optim$feature_fraction <- 0.398791273325751
PARAM$finalmodel$optim$min_data_in_leaf <- 13989
