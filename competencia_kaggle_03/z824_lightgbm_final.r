...
PARAM$finalmodel$optim$num_iterations <- 866
PARAM$finalmodel$optim$learning_rate <- 0.0395516218000341
PARAM$finalmodel$optim$feature_fraction <- 0.356957621213255
PARAM$finalmodel$optim$min_data_in_leaf <- 15412
PARAM$finalmodel$optim$num_leaves <- 1019
