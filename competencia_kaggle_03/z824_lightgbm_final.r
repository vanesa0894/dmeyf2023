...
PARAM$finalmodel$optim$num_iterations <- 35
PARAM$finalmodel$optim$learning_rate <- 0.0989972746309919
PARAM$finalmodel$optim$feature_fraction <- 0.663615414694706
PARAM$finalmodel$optim$min_data_in_leaf <- 19026
