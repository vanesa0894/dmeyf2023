...
PARAM$finalmodel$optim$num_iterations <- 711
PARAM$finalmodel$optim$learning_rate <- 0.0339451456615412
PARAM$finalmodel$optim$feature_fraction <- 0.95554945673612
PARAM$finalmodel$optim$min_data_in_leaf <- 10267
